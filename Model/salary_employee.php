...
<body>
  ...
  <div class="col-lg-4"><h4>ID</h4></div>
  <div class="col-lg-4"><h4>Amount</h4></div>
  <div class="col-lg-4"><h4>Weapon</h4></div>
  </div>
  ...
  <div class="col-lg-4"><?php echo $row[0];?></div>
  <div class="col-lg-4"><?php echo $row[1];?></div>
  <div class="col-lg-4"><?php echo $row[2];?></div>
  </div>
	<?php
	  }
  }
